package com.shenbh.scframe.utils.file;
 ...
 * <p>
 * 私有目录(外部存储的App的包名下)
 * Context.getExternalFilesDir()->/storage/emulated/0/Android/data/com.shenbh.scframe/files
 * Context.getExternalCacheDir()->/storage/emulated/0/Android/data/com.shenbh.scframe/cache
 * <p>
