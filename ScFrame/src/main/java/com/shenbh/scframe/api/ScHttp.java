package com.shenbh.scframe.api;

import android.app.Application;
import android.content.Context;

import com.blankj.utilcode.util.StringUtils;
import com.shenbh.scframe.api.interceptor.CustomSignInterceptor;
import com.shenbh.scframe.api.interceptor.DynamicMapStrategy;
...
public final class ScHttp {
    ...
    public static final class Builder {
        ...
        /**
         * 添加参数签名拦截器{@link com.shenbh.scframe.api.interceptor.CustomSignInterceptor}
         *
         * @param strategy
         */
        ...
        /**
         * 添加参数签名拦截器{@link com.shenbh.scframe.api.interceptor.TokenInterceptor}
         *
         * @param interceptor
         */
